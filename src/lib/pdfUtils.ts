...
export const downloadReportAsPDF = async (
  ...
  pdf.text('SmartMed+ Medical Report', pageWidth / 2, currentY, { align: 'center' });
  currentY += 10;
  ...
  // Add a note about SmartMed+
  pdf.setFontSize(8);
  pdf.setTextColor(100, 100, 100);
  pdf.text('Generated by SmartMed+ AI-Powered Medical Diagnostics', pageWidth / 2, pageHeight - margin - 6, { align: 'center' });
